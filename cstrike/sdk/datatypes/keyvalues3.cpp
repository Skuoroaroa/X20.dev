...
bool CKeyValues3::LoadKV3(CUtlBuffer* buffer)
{
	...
	static const fnLoadKeyValues oLoadKeyValues = reinterpret_cast<fnLoadKeyValues>(MEM::GetAbsoluteAddress(MEM::FindPattern(TIER0_DLL, CS_XOR("E8 ? ? ? ? 8B 4C 24 34 0F B6 D8")), 0x1, 0x0));
